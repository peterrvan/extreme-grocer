 ...
 */
 ...
 export const SEARCH = 'SEARCH'; //Adds search results into searchList array
 export const UPDATE_SEARCH = 'UPDATE_SEARCH'; //Updates the search string as user types into form
